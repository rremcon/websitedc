...
// Alleen een 'overkoepelend element zoals bijv. een div etc. kan styling bevatten.
// Een overkoepelend <>fragment</> kan geen styling bevatten.

// rsf(tab) = sneltoets voor het aanmaken van componenten. (begint met (function)).
// rsc(tab) = sneltoets voor arrowfunctie. (begint met (const)).
